...
public abstract class SingletonGameStateObserver<T> :  Singleton<T>,IEventHandler where T:Component
{
	public virtual void SubscribeEvents()
	{
        ...
        EventManager.Instance.AddListener<GameRetryEvent>(GameRetry);
	...
	public virtual void UnsubscribeEvents()
	{
        ...
        EventManager.Instance.RemoveListener<GameRetryEvent>(GameRetry);
    ...
    protected virtual void GameRetry(GameRetryEvent e)
    {
    }
